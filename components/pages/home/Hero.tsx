        ...
        <div className="flex h-full max-h-full w-full max-w-full items-end overflow-hidden">
          ...
          <div className="hero-overlay absolute top-1/2 z-[1] flex max-h-fit w-full -translate-y-1/2 flex-col items-center justify-center overflow-hidden p-[20px]">
            <Copy animateOnScroll={false} delay={1.55}>
              <p className="pb-[12px] text-center font-sans text-[56px] leading-[64px] font-medium tracking-[-0.5px] text-[#FFF] max-sm:pb-[8px] max-sm:text-[40px] max-sm:leading-[48px]">
            ...
            <Copy delay={1.8} animateOnScroll={false}>
              <p className="pb-[8px] font-sans text-[28px] leading-[36px] font-normal tracking-[4px] text-[#BCB19B] uppercase max-sm:pb-[12px] max-sm:text-[20px]">
                MIAMI - DUBAI - PARIS
              </p>
            </Copy>
          </div>

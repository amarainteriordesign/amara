  ...
  return (
    <section className="inspiration-container relative flex min-h-screen w-full flex-col justify-end">
      <video
        ...
        poster="/images/pages/home/Ocean_Video_Poster_Amara_Interior_Design_Procurement_Miami_Dubai.webp"
        muted={isMuted}
      ...
      <div className="absolute z-[1] flex h-full w-full flex-col items-center justify-center p-[20px]">
        ...
        <div className="max-h-fit w-full overflow-hidden text-center">
          <p className="inspirations-text translate-y-[-120%] text-[28px] leading-[36px] font-normal tracking-[-0.8px] text-[#F6EFE5] text-[#FFF] max-sm:text-[24px] max-sm:tracking-[-0.7]" style={{ fontFamily: 'var(--font-lora)' }}>
            Every project has a story,
          </p>
        </div>

        <Copy delay={0.2}>
          <p className="pb-[8px] text-[28px] leading-[36px] tracking-[-0.8px] text-[#F6EFE5] italic max-sm:text-[24px] max-sm:tracking-[-0.7]" style={{ fontFamily: 'var(--font-lora)' }}>

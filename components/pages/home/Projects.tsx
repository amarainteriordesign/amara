  ...
  return (
    <section className="project-home-ref w-full max-w-full overflow-hidden pb-[181px] max-sm:pb-[93px]">
      <div className="flex flex-col items-center justify-center px-[20px] pt-[80px] pb-[55px] max-sm:pt-[40px] max-sm:pb-[54px]">
        <h3 className="text-bg-img bg-[url(/images/pages/home/text-background.png)] !bg-top pb-[9px] text-center font-serif text-[32px] leading-[40px] tracking-[0.2px] italic max-sm:pb-[16px] max-sm:text-[22px] max-sm:leading-[28px] max-sm:tracking-[0.2px]">

...
import Quote from "../philosophy/Quote";
    ...
    <>
      <section className="w-full">
        <div className="flex w-full flex-col items-center justify-center px-[16px] py-[195px] max-md:py-[144px]">
          <h3 className="text-bg-img bg-[url(/images/pages/home/text-background.png)] !bg-top pb-[9px] font-serif text-[28px] leading-[36px] tracking-[-0.8px] italic max-sm:pb-[7px] max-sm:text-[22px] max-sm:tracking-[-0.6px]">

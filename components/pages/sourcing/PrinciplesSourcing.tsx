        ...
        <div className="flex-1 max-md:order-2">
          ...
          <div>
            ...
            <div className="mt-[48px] space-y-[48px] max-sm:mt-[32px] max-sm:space-y-[36px]">
              ...
              <div>
                <h3 className="text-[22px] leading-[30px] font-semibold tracking-[0.2px] text-[#262626] max-sm:text-[18px] max-sm:leading-[24px]" style={{ fontFamily: 'var(--font-cormorant)', fontVariantNumeric: 'lining-nums' }}>

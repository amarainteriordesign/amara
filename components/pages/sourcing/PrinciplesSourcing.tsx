...
export default function PrinciplesSourcing() {
  ...
  return (
    <section className="bg-background sourcing-principle-container-anim-main relative h-[calc(100vh+1100px)] min-h-[800px] w-full max-md:h-[calc(180vh)] max-md:h-fit max-md:min-h-fit">
      ...
      <div className="hidden max-w-[1440px] px-[24px] max-md:block">
        <div className="mx-auto mt-[40px] mb-[40px] flex max-w-[500px] flex-col gap-[32px] max-sm:max-w-full max-sm:px-[16px]">
          <div className="sourcing-mobile-principle-step opacity-0">
            <p className="font-display text-[13px] leading-[18px] tracking-[2px] uppercase text-[#62513A] mb-[8px]">Cost Efficiency</p>
            <p className="font-sans text-[14px] leading-[21px] text-[#1A1A1E99] max-sm:text-[13px] max-sm:leading-[19px]">
          ...
          <div className="sourcing-mobile-principle-step opacity-0">
            <p className="font-display text-[13px] leading-[18px] tracking-[2px] uppercase text-[#62513A] mb-[8px]">Top-Tier Quality</p>
            <p className="font-sans text-[14px] leading-[21px] text-[#1A1A1E99] max-sm:text-[13px] max-sm:leading-[19px]">
          ...
          <div className="sourcing-mobile-principle-step opacity-0">
            <p className="font-display text-[13px] leading-[18px] tracking-[2px] uppercase text-[#62513A] mb-[8px]">Fast Delivery & Execution</p>
            <p className="font-sans text-[14px] leading-[21px] text-[#1A1A1E99] max-sm:text-[13px] max-sm:leading-[19px]">
          ...
          <div className="sourcing-mobile-principle-step opacity-0">
            <p className="font-display text-[13px] leading-[18px] tracking-[2px] uppercase text-[#62513A] mb-[8px]">Global Reach & Logistics</p>
            <p className="font-sans text-[14px] leading-[21px] text-[#1A1A1E99] max-sm:text-[13px] max-sm:leading-[19px]">
      ...
      <div className="sourcing-principle-container-anim absolute top-0 right-0 h-full w-[45vw] max-md:relative max-md:h-[100vw] max-md:w-full max-md:static">

  ...
  return (
    <section className="bg-background sourcing-principle-container-anim-main relative w-full max-md:h-fit max-md:min-h-fit">
      <div className="mx-auto max-w-[1440px] px-[24px] py-[108px] max-md:py-[48px]">
        <h3 className="text-center text-[80px] leading-[80px] font-normal tracking-[1px] text-[#62513A] max-md:text-[48px] max-md:leading-[48px] max-sm:text-[32px] max-sm:leading-[32px]" style={{ fontFamily: 'var(--font-libre-caslon-display)' }}>
          OUR APPROACH
        </h3>
      </div>

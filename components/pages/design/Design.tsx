      ...
      <div className="mx-auto flex w-full max-w-[1440px] items-end justify-between gap-[40px] px-[20px] max-md:flex-col max-md:items-center max-md:gap-0 max-md:px-[17px]">
        ...
        <div className="max-xmd:max-w-[270px] flex max-w-[309px] shrink flex-col items-start gap-[60px] max-md:max-w-[500px] max-md:gap-[46px] max-sm:max-w-full">
          <div className="flex w-full flex-col max-md:items-center">
            <h3 className="text-gradient-vertical pb-[6px] font-serif text-[28px] leading-[36px] tracking-tighter italic max-md:pb-[16px] max-sm:text-center max-sm:text-[24px]">
          ...
          <p className="mb-[26px] w-full font-serif text-[14px] leading-[21px] font-normal tracking-[3%] text-[#262626] max-md:mb-0 max-md:pb-[33px] max-sm:max-w-full max-sm:text-[12px]">
        ...
        <p className="max-xmd:mr-0 max-xmd:max-w-[270px] mr-[140px] mb-[26px] max-w-[309px] shrink-0 font-serif text-[14px] leading-[21px] font-normal tracking-[3%] text-[#262626] max-md:mb-0 max-md:max-w-[500px] max-sm:max-w-full max-sm:text-[12px]">

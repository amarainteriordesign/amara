  ...
  return (
    <section className="w-full bg-[#F5F1ED] py-[60px] max-md:py-[50px] max-sm:py-[40px]">
      ...
      <div className="mb-[60px] flex w-full flex-col items-center justify-center px-[20px] text-center max-sm:mb-[40px]">
        ...
        <a
          href="https://wa.link/8a907o"
          target="_blank"
          rel="noopener noreferrer"
          className="mt-[30px] flex h-[39px] items-center gap-[8px] self-center rounded-[35px] border-[1px] border-[#26262699] px-[16px] font-sans text-[12px] font-medium tracking-[0.2px] text-[#262626] transition-all hover:bg-[#262626] hover:text-white max-sm:mt-[24px] max-sm:h-[32px] max-sm:px-[14px] max-sm:text-[11px]"
        >
          <svg
      ...
      {/* Studio Section + Founders Image Side by Side on Desktop */}
      <div className="mb-[60px] flex w-full flex-col md:flex-row md:items-stretch max-sm:mb-[40px]">
        {/* Studio Section (Black Block) - LEFT on desktop */}
        <div className="w-full md:w-1/2 md:flex md:items-stretch md:order-1 order-2">

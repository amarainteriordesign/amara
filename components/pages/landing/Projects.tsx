...
export default function Projects() {
  ...
  return (
    <section className="project-landing-ref w-full max-w-full overflow-hidden pb-[181px] max-sm:pb-[93px]">
      ...
      <div className="flex flex-col items-center justify-center px-[20px] pt-[23px] max-sm:pt-[25px]">
        ...
        <a
          ...
          className="flex h-[39px] items-center gap-[8px] self-center rounded-[35px] border-[1px] border-[#26262699] px-[16px] font-sans text-[12px] font-medium tracking-[0.2px] text-[#262626] transition-all hover:bg-[#262626] hover:text-white max-sm:h-[32px] max-sm:px-[14px] max-sm:text-[11px]"
        >
          <svg

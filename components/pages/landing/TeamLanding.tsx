...
export default function TeamLanding() {
  return (
    <section id="team-landing" className="relative w-full">
      ...
      <div className="relative z-[2] mx-auto flex w-full max-w-[1440px] flex-col items-center px-[20px] pb-[40px] max-md:pb-[30px]">
        ...
        >
          <div className="relative flex h-[63vh] flex-col justify-between gap-[20px] rounded-[8px] max-md:h-[76vh] max-sm:h-[427px]">
            <Image
              src="/images/pages/studio/Eloise_Chauviere_Amara_Interior_Design_Procurement_Miami_Dubai.webp"
          ...
          <div className="relative flex h-[63vh] flex-col justify-between gap-[20px] rounded-[8px] max-md:h-[76vh] max-sm:h-[427px]">
            <Image
              src="/images/pages/studio/Ines_Bakkali_Amara_Interior_Design_Procurement_Miami_Dubai.webp"
              alt="INES BAKKALI"
              width={417}
              height={515}
              className="absolute top-0 right-0 h-full w-full overflow-hidden rounded-[8px] object-cover"

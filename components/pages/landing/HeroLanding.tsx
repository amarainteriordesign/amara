        ...
        <div className="flex h-full max-h-full w-full max-w-full items-end overflow-hidden">
          ...
          <div className="hero-overlay-landing absolute top-1/2 z-[1] flex max-h-fit w-full -translate-y-1/2 flex-col items-center justify-center overflow-hidden p-[20px]">
            <Copy animateOnScroll={false} delay={1.55}>
              <p className="pb-[12px] text-center font-display text-[46px] leading-[54px] font-normal tracking-[-0.5px] uppercase text-[#FFF] max-sm:pb-[8px] max-sm:text-[32px] max-sm:leading-[40px]" style={{ textShadow: '0 2px 8px rgba(0,0,0,0.4)' }}>
            ...
            <Copy delay={1.8} animateOnScroll={false}>
              <p className="pb-[8px] font-sans text-[13px] leading-[20px] font-normal tracking-[4px] text-white uppercase max-sm:pb-[12px] max-sm:text-[10px]" style={{ textShadow: '0 2px 8px rgba(0,0,0,0.4)' }}>
                MIAMI - DUBAI - PARIS
              </p>
            </Copy>
          </div>

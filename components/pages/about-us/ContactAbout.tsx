...
export default function ContactAbout() {
  return (
    <section className="bg-[#e8dfd2] w-full">
      <div className="relative mx-auto flex w-full max-w-[1440px] flex-col px-[20px] pt-[30px] pb-[80px] max-md:pt-[20px] max-md:pb-[60px] max-sm:px-[12px] max-sm:pt-[16px] max-sm:pb-[40px]">

      ...
      <div className="mx-auto w-full max-w-[1400px] px-[60px] pt-[100px] pb-[140px] max-md:px-[40px] max-md:pt-[60px] max-md:pb-[60px] max-sm:px-[20px] max-sm:pt-[40px] max-sm:pb-[40px]">
          ...
          <div className="flex gap-[40px]">
            <div className="w-[48%]">
              <div className="relative h-[750px] w-full overflow-hidden rounded-[8px]">
                <Image src="/images/pages/studio/Eloise_Chauviere_Amara_Interior_Design_Procurement_Miami_Dubai.webp" alt="ELOISE CHAUVIERE" fill sizes="(max-width: 768px) 100vw, 48vw" className="rounded-[8px] object-cover" />
              ...
              <div className="mt-[60px]">
                <h3 className="pb-[12px] font-sans text-[14px] leading-[20px] font-bold tracking-[1.8px] text-[#262626] uppercase">Ines Bakkali</h3>
                <p className="font-sans text-[16px] leading-[28px] font-normal tracking-[-0.2px] text-[#262626]" style={{ textAlign: 'justify' }}>
                  Creative and design-led, Ines leads the creative vision at Amara. As Design Director, she oversees concept development, spatial planning, and material selection, ensuring each project is cohesive, functional, and thoughtfully executed.
                </p>
              </div>
            </div>
            <div className="w-[52%]">
              ...
              <div className="mt-[60px]">
                <div className="relative h-[750px] w-full overflow-hidden rounded-[8px]">
                  <Image src="/images/pages/studio/Ines_Bakkali_Amara_Interior_Design_Procurement_Miami_Dubai.webp" alt="INES BAKKALI" fill sizes="(max-width: 768px) 100vw, 50vw" className="rounded-[8px] object-cover" />
        ...
        <div className="hidden max-md:flex max-md:flex-col max-md:gap-[40px]">
          <div className="relative h-[500px] w-full overflow-hidden rounded-[8px] max-sm:h-[400px]">
            <Image src="/images/pages/studio/Eloise_Chauviere_Amara_Interior_Design_Procurement_Miami_Dubai.webp" alt="ELOISE CHAUVIERE" fill sizes="100vw" className="rounded-[8px] object-cover" />
            <PhotoOverlay name="ELOISE CHAUVIERE" title="Managing Director" position="top" links={{ whatsapp: "https://api.whatsapp.com/send?phone=13055604373", linkedin: "https://www.linkedin.com/in/eloïse-chauviere-44b93b159" }} />
          </div>
          <div>
            <h3 className="pb-[12px] font-sans text-[14px] leading-[20px] font-bold tracking-[1.8px] text-[#262626] uppercase">Eloise Chauviere</h3>
          ...
          <div className="relative h-[500px] w-full overflow-hidden rounded-[8px] max-sm:h-[400px]">
            <Image src="/images/pages/studio/Ines_Bakkali_Amara_Interior_Design_Procurement_Miami_Dubai.webp" alt="INES BAKKALI" fill sizes="100vw" className="rounded-[8px] object-cover" />
            <PhotoOverlay name="INES BAKKALI" title="Design Director" position="bottom" links={{ whatsapp: "https://api.whatsapp.com/send?phone=13055604373", linkedin: "https://www.linkedin.com/in/inesbakkali/" }} />
          </div>
          <div>
            <h3 className="pb-[12px] font-sans text-[14px] leading-[20px] font-bold tracking-[1.8px] text-[#262626] uppercase">Ines Bakkali</h3>
            <p className="font-sans text-[14px] leading-[24px] font-normal tracking-[-0.2px] text-[#262626]" style={{ textAlign: 'justify' }}>Creative and design-led, Ines leads the creative vision at Amara. As Design Director, she oversees concept development, spatial planning, and material selection, ensuring each project is cohesive, functional, and thoughtfully executed.</p>
          </div>
        </div>

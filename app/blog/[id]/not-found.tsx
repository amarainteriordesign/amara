    ...
    <>
      ...
      <div className="flex min-h-screen flex-col items-center justify-center px-4">
        <div className="text-center">
          ...
          <h2 className="mb-6 font-serif text-2xl text-gray-700">Blog Article Not Found</h2>
          <p className="mb-8 max-w-md text-gray-600">
            The blog article you&#39;re looking for doesn&#39;t exist or may have been removed.
          </p>
          <Link
            href="/blog"
